...
(function (global, factory) {
    if (typeof Bone.Events == 'undefined') {
        console.error('cannot find Bone, pls add foxUI.js')
    }
    //bone+vue+vuex
    if(typeof define === 'function'){
        define('vue', function (require, exports, module) {
            Bone.Vue = factory();
            module.exports =  Bone.Vue;
        });

    }else{
        (  global.Vue = Bone.Vue  = factory() );
    }

}(this, (function () {
    'use strict';
    // to see Vue.js v2.2.6 ,https://cn.vuejs.org/v2/api
    var previousVue = window.Vue;
    Bone.previousVue = function() {
        window.Vue  = previousVue;
        return window.Vue;
    };
     ...
     * vue加上bone.view的逻辑
     */
    //eventsMixin,renderMixin
    Bone._isUseVue    = true; //开关 true 开|false 关
    Bone.VueViewMixin = function (Vue, Bone) {
        "use strict";

        //  eventsMixin for vue 自定义扩展events['on', 'once', 'off', 'trigger', 'stopListening', 'listenTo', 'listenToOnce', 'bind', 'unbind'];
        if (typeof Bone !== 'undefined' && Bone.Events && typeof Vue.listenTo !== 'function' ) {
            Bone.Events.mixin(Vue.prototype);
        }
        var viewOptions = ['model','el','id','attributes', 'className', 'events','initialize']; //copy to vue this
        //initview 实例化
        Vue.prototype._initRenderView = function (options) {
            if(!Bone._isUseVue){ return this; }
            _.extend(this, _.pick(options || this.$options, viewOptions));
            this._evtuid ='view'+(this._uid);
            this._ensureElement();
        ...
        //  viewMixin for vue ,原形链
        Vue._renderViewMixin = function (Vue) {
            if(!Bone._isUseVue){ return this; }
            _.extend(Vue.prototype, {
                ...
                // view mounted is an empty function by default. Override it with your own logic.
                ...
                delegateEvents: function (events) {
                    ...
                    for (var key in events) {
                        ...
                        var fn = events[key];
                        if (! _.isFunction(fn)){
                            fn = this[fn] || this.fn ||this[method];
                        }
                        if (!fn) continue;
                        var match = key.match(delegateEventSplitter);
                        this.delegate(match[1], match[2], _.bind(fn, this));
                    }
                    return this;
                },
                delegate: function (eventName, selector, listener) {
                    this.$dd.on(eventName + '.delegateEvents' + this._evtuid, selector, listener);
                    return this;
                },
                undelegateEvents: function () {
                    if (this.$dd) this.$dd.off('.delegateEvents' + this._evtuid);
                    return this;
                },
                undelegate: function (eventName, selector, listener) {
                    this.$dd.off(eventName + '.delegateEvents' + this._evtuid, selector, listener);
                    return this;
                },
                _ensureElement: function (el) {
                    //vue create 调用
                    //把vdom的root赋值给$dd
                    var rootEl = el|| this.el || this.$options.el|| this.$el ||'';
                ...
                serialize: function () {
                    ...
                    return this._serializeModel.apply(this, args);
                }
            });
            return this;
        };
...
// on their elm reference.
    ...
    var normalizeEvent = cached(function (name) {
        var once1 = name.charAt(0) === '~'; // Prefixed last, checked first
        name = once1 ? name.slice(1) : name;
...
// is needed to cater to all possible types of children values.
    ...
    function updateComponentListeners(vm,
                                      ...
                                      oldListeners) {
        target = vm;
        updateListeners(listeners, oldListeners || {}, add, remove1, vm);
    }
    ...
    function lifecycleMixin(Vue) {
        ...
        Vue.prototype.$destroy = function () {
            ...
            vm.$off();
            vm.unbindViewEvents && vm.unbindViewEvents();
    ...
    function mountComponent(vm, el, hydrating) {
        ...
        vm.viewRendered && vm.viewRendered();
        vm.bindViewEvents && vm.bindViewEvents();
        return vm
    }
...
// without getting yelled at by flow
    ...
    /* core/instance/render-helpers/render-filter.js  */
    ...
    /* core/instance/render-helpers/bind-object-props.js */
    ...
    /* core/instance/render-helpers/render-static.js */
            ...
            var loop = function (i) {
                ...
                while (source) {
                    if (source._provided && provideKey in source._provided) {
                        /* istanbul ignore else */
                        {
                            defineReactive(vm, key, source._provided[provideKey], function () {
                                warn(
    ...
    function initMixin(Vue) {
        Vue._renderViewMixin && Vue._renderViewMixin(Vue);
        ...
        Vue.prototype._init = function (options) {
            ...
            initEvents(vm);
            initRender(vm);
            vm._initRenderView && vm._initRenderView(options); //bone initRenderView
...
//Vue Class
    ...
    Bone.VueViewMixin && Bone.VueViewMixin(Vue,Bone);
    initMixin(Vue);
    stateMixin(Vue);
    eventsMixin(Vue);
    lifecycleMixin(Vue);
...
// contain child elements.
    ...
    /* platforms/web/runtime/node-opts.js */
...
// so they need to be treated as different nodes
    ...
    function _update(oldVnode, vnode) {
        ...
        var oldDirs = _normalizeDirectives(oldVnode.data.directives, oldVnode.context);
        var newDirs = _normalizeDirectives(vnode.data.directives, vnode.context);
    ...
    function _normalizeDirectives(dirs, vm) {
    ...
    /* platforms/runtime/modules/attrs.js */
    ...
    /* platforms/runtime/modules/class.js  */
...
// normalize possible array / string values into Object
    ...
    /* platforms/web/runtime/modules/style.js */
    ...
    /* platforms/web/runtime/class-util.js */
        ...
        if (config.devtools) {
            if (devtools) {
                ...
                console[console.info ? 'info' : 'log'](
                    'Download the Vue vue-devtools extension for a better development'
                );
            }
        }
        if ("development" !== 'production' &&
...
// IE encodes newlines inside attribute values while other browsers don't
    ...
    /* platforms/web/compiler/utils.js  */
...
// Phrasing Content https://html.spec.whatwg.org/multipage/dom.html#phrasing-content
    ...
    /* compiler/parser/entity-decoder.js */
...
// configurable state
    ...
    function processOnce(el) {
        var once1 = getAndRemoveAttr(el, 'v-once');
        if (once1 != null) {
            el.once = true;
        }
    }
...
// the listener for .once
    ...
    function directivesBind(el, dir) {
...
// detect problematic expressions in a template
    ...
    Bone._initVuex = function (Bone,Vue) {
        
        // vuex v2.3.0
        var applyMixin = function (Vue) {
            var usesInit = Vue.config._lifecycleHooks.indexOf('init') > -1;
            Vue.mixin(usesInit ? { init: vuexInit } : { beforeCreate: vuexInit });
            console.info('applyMixin vuexInit  !');
            function vuexInit () {
                var options = this.$options;
                if (options.store) {
        ...
        function install (_Vue) {
            if (isInstal) {
                console.log('Vue isInstal'+isInstal)
                return
            }
            Vue = _Vue;
            applyMixin(Vue);
        ...
        window.Vuex = Bone.Vuex;
        return Bone.Vuex;

    };

    Bone._initVuex(Bone,Vue);
    //Vue.use(Bone.Vuex);
    return Vue;
})));
