 ...
 *   @version    : 1.0.7
 *   @update-log :
 *                 1.0.1 - 20150220 周国庆 VARS扩展设备、平台判断的相关参数和部分方法扩展
 *                 1.0.2 - 20150320 陈  龙 新增note3判断参数IsSAMSUNGNote3
 *                                         新增IsBaiduBoxApp、IsOldBaiduBrowser和IsNewUCBrowser参数
 *                 1.0.3 - 20150420 陈  龙 新增SVP_URL参数
 *                                         新增IsSoGouBrowser参数
 *                 1.0.4 - 20150520 陈  龙 新增VSTAR_API_URL、VSTAR_PXY_URL、VSTAR_PXY_TEST_URL、VSTAR_MAIN_PATH、IsSohuVideoClient参数
 *                 1.0.5 - 20150620 陈  龙 新增IsPC字段
 *                 1.0.6 - 20160425 陈  龙 新增IsSohuVideoPadClient、IsSohuVideoPadClient字段
 *                 1.0.7 - 20160519 陈  龙 新增PROTOCOL参数
 *                                         将url中的http://转换为vars.PROTOCOL
 **/
...
define('base/vars',function(require, exports, module) {
  ...
  window.SohutvJSBridge = window.SohutvJSBridge || {};
   //别相互循环嵌套
  VARS.getQueryString = __getQueryString = function (p, u) {
