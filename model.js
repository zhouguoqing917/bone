...
Model.extend = Bone.extend;

// Attach all inheritable methods to the Model prototype.
_.extend(Model.prototype, Bone.CommonMixin, Bone.RadioMixin,Bone.Events, {
    ...
    parse: function(resp, options) {
        if(resp && resp.data){
            this.attributes.data = resp.data;
            this.trigger("response",resp.data);
            return resp.data;
        }else{
...
Bone.addUnderscoreMethods(Model, modelMethods, 'attributes');
